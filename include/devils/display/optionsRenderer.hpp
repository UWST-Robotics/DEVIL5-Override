...
namespace devils
{
    ...
    private:
        ...
        void createOptionsDisplayContainer(const char* bot_name, const std::vector<Routine>& routines)
        {
            ...
            // center
            lv_obj_set_flex_align(fullscreen_container, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER,
        ...
        static void handleRoutineChange(const std::string& selected_routine)
        {
            Routine new_routine;
            for (const auto& routine : routines)
            {
